...
/* harmony import */ var _modules_init_rewies_slider__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/init-rewies-slider */ "./js/modules/init-rewies-slider.js");
...
/* harmony import */ var _modules_screen_controller__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./modules/screen-controller */ "./js/modules/screen-controller.js");
/* harmony import */ var _modules_cookie_cookie_consent_checker__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./modules/cookie/cookie-consent-checker */ "./js/modules/cookie/cookie-consent-checker.js");
/* harmony import */ var _modules_init_animation__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./modules/init-animation */ "./js/modules/init-animation.js");
...
/* harmony import */ var _modules_init_iframe__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./modules/init-iframe */ "./js/modules/init-iframe.js");
/* harmony import */ var _modules_form_init_fix_label__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./modules/form/init-fix-label */ "./js/modules/form/init-fix-label.js");
/* harmony import */ var _modules_check_os__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./modules/check-os */ "./js/modules/check-os.js");
...
var header = new _modules_header__WEBPACK_IMPORTED_MODULE_6__["Header"]();
var screenController = new _modules_screen_controller__WEBPACK_IMPORTED_MODULE_7__["ScreenController"]();
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    Object(_modules_init_rewies_slider__WEBPACK_IMPORTED_MODULE_4__["initReviewsSlider"])();
    Object(_modules_tabs_init_tabs__WEBPACK_IMPORTED_MODULE_5__["initTabs"])();
    header.init();
    screenController.init();
    Object(_modules_cookie_cookie_consent_checker__WEBPACK_IMPORTED_MODULE_8__["cookieConsentChecker"])();
    Object(_modules_init_animation__WEBPACK_IMPORTED_MODULE_9__["initAnimation"])();
    Object(_modules_accordion_init_accordion__WEBPACK_IMPORTED_MODULE_10__["initAccordions"])();
    Object(_modules_init_iframe__WEBPACK_IMPORTED_MODULE_11__["initIframe"])();
    Object(_modules_check_os__WEBPACK_IMPORTED_MODULE_13__["checkMobileOS"])();
    Object(_modules_form_init_fix_label__WEBPACK_IMPORTED_MODULE_12__["initFixLabel"])();
  });
}); // ---------------------------------
...
/***/ "./js/modules/check-os.js":
/*!********************************!*\
  !*** ./js/modules/check-os.js ***!
  \********************************/
/*! exports provided: checkMobileOS */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "checkMobileOS", function() { return checkMobileOS; });
...
var breakpointChecker = function breakpointChecker() {
  if (breakpoint.matches) {
    if (/iPhone|iPad/i.test(navigator.userAgent)) {
      bottomBlock.querySelector('[data-link="playmarket"]').classList.remove('is-active');
      bottomBlock.querySelector('[data-link="appstore"]').classList.add('is-active');
    } else {
      bottomBlock.querySelector('[data-link="appstore"]').classList.remove('is-active');
      bottomBlock.querySelector('[data-link="playmarket"]').classList.add('is-active');
    }
  }
};

var checkMobileOS = function checkMobileOS() {
  if (!bottomBlock) {
    return;
  }
...
/***/ "./js/modules/cookie/cookie-consent-checker.js":
/*!*****************************************************!*\
  !*** ./js/modules/cookie/cookie-consent-checker.js ***!
  \*****************************************************/
...
/* harmony import */ var _cookie__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./cookie */ "./js/modules/cookie/cookie.js");
...
/***/ "./js/modules/form/init-fix-label.js":
/*!*******************************************!*\
  !*** ./js/modules/form/init-fix-label.js ***!
  \*******************************************/
/*! exports provided: initFixLabel */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initFixLabel", function() { return initFixLabel; });
var inputWrappers = document.querySelectorAll('.custom-input');

var initFixLabel = function initFixLabel() {
  if (!inputWrappers) {
    return;
  }
...
var customServiceSuccessCallback = function customServiceSuccessCallback(e) {
  e.preventDefault();
  resetForm(e.target);
  var form = e.target.closest('.feedback__form');
  form.classList.add('is-send');
  form.querySelector('.feedback__success .btn').addEventListener('click', function () {
    return form.classList.remove('is-send');
  });
};
...
var callbacks = {
  ...
  service: {
    validationSuccessCallback: customServiceSuccessCallback,
    validationErrorCallback: customExampleValidationErrorCallback
  }
};
...
var Header = /*#__PURE__*/function () {
  function Header() {
    ...
    this._headerBurger = document.querySelector('[data-header-burger]');
    this._cardAnimation = document.querySelector('[data-card]');
    this._background = document.querySelector('[data-background]');
    this._bottomBlock = document.querySelector('[data-bottom-block]');
    this._activeScreen = null;
    this._onHeaderBurgerClick = this._onHeaderBurgerClick.bind(this);
    this._onDocumentKeydown = this._onDocumentKeydown.bind(this);
    this._focusLock = new _utils_focus_lock__WEBPACK_IMPORTED_MODULE_0__["FocusLock"]();
    this._scrollLock = new _utils_scroll_lock__WEBPACK_IMPORTED_MODULE_1__["ScrollLock"]();
  }
  ...
  _createClass(Header, [{
    ...
    value: function closeHeader() {
      ...
      this._activeScreen = document.querySelector('.screen.is-active');
      ...
      if (this._background) {
        this._background.classList.remove('is-moved');
      }

      if (this._cardAnimation) {
        this._cardAnimation.classList.remove('is-moved');
      }

      if (this._activeScreen) {
        if (this._activeScreen.classList.contains('right-screen')) {
          this._activeScreen.classList.remove('is-moved-2');
        } else if (this._activeScreen.classList.contains('center-screen')) {
          this._activeScreen.classList.remove('is-moved-3');
        } else if (this._activeScreen.classList.contains('join-screen')) {
          this._activeScreen.classList.remove('is-moved-4');
        } else if (this._activeScreen.classList.contains('final-screen')) {
          this._activeScreen.classList.remove('is-moved-5');
        } else {
          this._activeScreen.classList.remove('is-moved');
        }
      }

      if (this._bottomBlock) {
        this._bottomBlock.classList.remove('is-moved');
      }
    }
  }, {
    key: "openHeader",
    value: function openHeader() {
      ...
      if (this._background) {
        this._background.classList.add('is-moved');
      }

      if (this._cardAnimation) {
        this._cardAnimation.classList.add('is-moved');
      }

      if (this._activeScreen) {
        if (this._activeScreen.classList.contains('right-screen')) {
          this._activeScreen.classList.add('is-moved-2');
        } else if (this._activeScreen.classList.contains('center-screen')) {
          this._activeScreen.classList.add('is-moved-3');
        } else if (this._activeScreen.classList.contains('join-screen')) {
          this._activeScreen.classList.add('is-moved-4');
        } else if (this._activeScreen.classList.contains('final-screen')) {
          this._activeScreen.classList.add('is-moved-5');
        } else {
          this._activeScreen.classList.add('is-moved');
        }
      }

      if (this._bottomBlock) {
        this._bottomBlock.classList.add('is-moved');
      }
    }
  }, {
    key: "_onHeaderBurgerClick",
    value: function _onHeaderBurgerClick(evt) {
      evt.preventDefault();
    ...
    value: function init() {
      ...
      this._headerBurger.addEventListener('click', this._onHeaderBurgerClick);
    }
  }]);
...
var THRESHOLD_DEFAULT = 1.0;
var DURATION_DEFAULT = 1.0;
var DELAY_DEFAULT = 0.1;
var screens = document.querySelectorAll('[data-animate]');
var elTop;
var windowHeight;

var returnAnimatePoint = function returnAnimatePoint(el, threshold) {
...
var trackingScreenBlock = function trackingScreenBlock() {
  screens.forEach(function (screen) {
    var threshold = screen.dataset.animateThreshold ? parseFloat(screen.dataset.animateThreshold) : THRESHOLD_DEFAULT;
    var duration = screen.dataset.animateDuration ? parseFloat(screen.dataset.animateDuration) : DURATION_DEFAULT;
    var delay = screen.dataset.animateDelay ? parseFloat(screen.dataset.animateDelay) : DELAY_DEFAULT;
    var items = screen.querySelectorAll('.fib');

    if (returnAnimatePoint(screen, threshold) > 0 && !screen.classList.contains('show')) {
      items.forEach(function (item, index) {
        item.style.animationDuration = "".concat(duration, "s");
        item.style.animationDelay = "".concat(index * delay, "s");
      });
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "initIframe", function() { return initIframe; });
// const VIDEOS = {
//   'about-weera': 'uJezm8rmn6s',
// };
var LANGUAGES = {
  'en': 'en',
  'it': 'it',
...
var getLangCode = function getLangCode() {
  var langCode = document.querySelector('html').getAttribute('lang');
  return langCode;
};

var initIframe = function initIframe() {
  if (!document.querySelector('[data-youtube-iframe]')) {
    return;
  }

  var getVideoId = function getVideoId() {
    return document.querySelector('[data-yt-video-id]').dataset.ytVideoId;
  };

  var ytVideoId = getVideoId() ? getVideoId() : '';
  ...
  if (!youtubeScript) {
    ...
    youtubeApiScript.id = youtubeScriptId;
    firstScript.parentNode.insertBefore(youtubeApiScript, firstScript);
  }

  var iframeBlock = document.querySelector('[data-youtube-iframe="about-weera"]');
  var playBtn = document.querySelector('[data-youtube-iframe="play-btn"]');
  var overlay = document.querySelector('[data-youtube-iframe="overlay"]');
  var player;
  var video = iframeBlock.dataset.youtubeIframe;
  ...
  window.onYouTubeIframeAPIReady = function () {
    ...
    function onPlayerReady(e) {
      ...
      document.addEventListener('click', function (evt) {
        ...
        if (!clickTarget.closest('[data-youtube-iframe="overlay"]') && !clickTarget.closest('[data-youtube-iframe="play-btn"]')) {
          return;
        }
    ...
    function onApiChange() {
      ...
      }); // const options1 = player.getOptions('captions');
      // console.log(options1);
      // player.setOption('captions', 'translationLanguages', {'languageCode': 'es-US'});
      // const options2 = player.getOptions('captions', 'fontSize');
...
/***/ "./js/modules/init-rewies-slider.js":
/*!******************************************!*\
  !*** ./js/modules/init-rewies-slider.js ***!
  \******************************************/
...
var reviewsSlider = document.querySelector('[data-slider]');
var breakpoint = window.matchMedia('(min-width: 768px)'); // eslint-disable-next-line no-unused-vars
...
var initSwiper = function initSwiper() {
  if (breakpoint.matches) {
    ...
    swiper = new Swiper(reviewsSlider, {
      speed: 300,
      loop: true,
      slidesPerView: 'auto',
      centeredSlides: true,
...
/***/ "./js/modules/screen-controller.js":
/*!*****************************************!*\
  !*** ./js/modules/screen-controller.js ***!
  \*****************************************/
/*! exports provided: ScreenController */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "ScreenController", function() { return ScreenController; });
...
var ScreenController = /*#__PURE__*/function () {
  function ScreenController() {
    ...
    this._bottomBlock = document.querySelector('[data-bottom-block]');
    this._nextScreenButtons = document.querySelectorAll('[data-next-screen]');
    this._cardAnimation = document.querySelector('[data-card]');
    this._background = document.querySelector('[data-background]');
    this._nextScreenTimerButton = document.querySelector('[data-next-screen-timer]');
    this._nextScreenTimerCircle = document.querySelector('.bottom-block__circle-above');
    this._headerLogo = document.querySelector('.header__logo');
    this._textLogo = document.querySelector('.acquaintance__logo-icon');
    this._breakpoint = window.matchMedia('(min-width:768px)');
    this._blockDelay = null;
    this._activeScreenIndex = 0;
    this._wheelShift = 15;
    this._onMouseWheel = null;
    this._wheels = [];
    this._wheelTimer = null;
    this._touchShift = 100;
    this._baseDelay = 1500;
    this._headerTimeout = 0;
    this._startPointY = null;
    this._startPointX = null;
    this._stopPointY = null;
    this._stopPointX = null;
    this._direction = null;
    this._fullTimeout = null;
    this._Header = new _header__WEBPACK_IMPORTED_MODULE_0__["Header"]();
    this._onWheelEvent = this._onWheelEvent.bind(this);
    this._onNextScreenButtonClick = this._onNextScreenButtonClick.bind(this);
    this._onWindowTouchStar = this._onWindowTouchStar.bind(this);
    this._onWindowTouchEnd = this._onWindowTouchEnd.bind(this);
  }

  _createClass(ScreenController, [{
    key: "_startAnimation",
    value: function _startAnimation() {
      var _this = this;

      this._wrapper.classList.remove('no-animation');

      this._activeScreenIndex = 0;
      this._blockDelay = +this._screens[0].dataset.showIn;

      this._screens[this._activeScreenIndex].classList.add('shown-in');

      this._header.classList.add('shown-in');

      this._bottomBlock.classList.add('shown-in');

      this._wrapper.classList.add('no-action');

      this._wrapper.classList.add('no-move');

      this._screens[this._activeScreenIndex].classList.add('is-active');

      this._background.style.backgroundColor = this._screens[this._activeScreenIndex].dataset.background;
      setTimeout(function () {
        _this._wrapper.classList.remove('no-action');

        _this._wrapper.classList.remove('no-move');

        _this._screens[_this._activeScreenIndex].classList.add('is-completed');

        _this._navigation.classList.add('shown-in');

        _this._bottomBlock.classList.add('is-completed');
      }, this._blockDelay);
    }
  }, {
    key: "_showLogo",
    value: function _showLogo() {
      ...
      if (!this._headerLogo || !this._textLogo) {
        return;
      }

      var baseLogoLeft = this._headerLogo.getBoundingClientRect().left;

      var baseLogoTop = this._headerLogo.getBoundingClientRect().top;

      var startLogoLeft = this._textLogo.getBoundingClientRect().left;

      var startLogoTop = this._textLogo.getBoundingClientRect().top;

      this._headerLogo.style.position = 'fixed';
      this._headerLogo.style.transform = 'translate(0%, 0%)';
      this._headerLogo.style.left = "".concat(startLogoLeft, "px");
      this._headerLogo.style.top = "".concat(startLogoTop, "px");
      this._headerLogo.style.transition = null;
      setTimeout(function () {
        _this2._headerLogo.style.opacity = 1;
        _this2._textLogo.style.opacity = 0;
        _this2._headerLogo.style.transition = 'left 1.4s ease, top 1.4s ease';
        _this2._headerLogo.style.left = "".concat(baseLogoLeft, "px");
        _this2._headerLogo.style.top = "".concat(baseLogoTop, "px");
      });
      setTimeout(function () {
        _this2._headerLogo.style = null;

        _this2._header.classList.add('is-completed');
      }, 1400);
      setTimeout(function () {
        _this2._textLogo.style = null;
      }, 2400);
    }
  }, {
    key: "_hideLogo",
    value: function _hideLogo() {
      ...
      setTimeout(function () {
        _this3._headerLogo.style.transition = 'opacity 0.6s ease';
        _this3._headerLogo.style.opacity = 0;
        
      }, 2000);
    }
  }, {
    key: "_changeScreens",
    value: function _changeScreens() {
      var _this4 = this;

      if (this._header.classList.contains('is-open')) {
        this._Header.closeHeader();

        this._headerTimeout = this._header.dataset.closeTimeout;
      } else {
        this._headerTimeout = 0;
      }

      var activeScreen = this._screens[this._activeScreenIndex];
      var currentScreen = this._screens[this._currentScreenIndex];
      var activeDelayOut = activeScreen.dataset.showOut ? +activeScreen.dataset.showOut : 0;
      var activeDelayIn = activeScreen.dataset.showIn ? +activeScreen.dataset.showIn : 0;
      var currentDelayOut = currentScreen.dataset.showOut ? +currentScreen.dataset.showOut : 0;
      var currentDelayIn = currentScreen.dataset.showIn ? +currentScreen.dataset.showIn : 0;
      var isHideBottom = currentScreen.hasAttribute('data-hide-bottom');
      var backgroundDelayIn = currentScreen.dataset.backgroundDelayIn ? +currentScreen.dataset.backgroundDelayIn : 0;
      var backgroundDelayOut = activeScreen.dataset.backgroundDelayOut ? +activeScreen.dataset.backgroundDelayOut : 0;
      ...
      setTimeout(function () {
        if (isHideBottom) {
          _this4._bottomBlock.classList.add('is-hide');
        } else {
          _this4._bottomBlock.classList.remove('is-hide');
        }

        if (currentScreen.hasAttribute('data-hide-bottom-btn')) {
          _this4._bottomBlock.classList.remove('is-downed');
        } else {
          _this4._bottomBlock.classList.add('is-downed');
        }

        if (!_this4._activeScreenIndex && _this4._currentScreenIndex === 1) {
          _this4._showLogo();
        }

        if (!_this4._currentScreenIndex && _this4._activeScreenIndex === 1) {
          _this4._hideLogo();
        }

        _this4._nextScreenTimerButton.classList.remove('is-active');

        _this4._nextScreenTimerCircle.classList.remove('is-active');

        _this4._nextScreenTimerCircle.style.transition = null;

        if (_this4._direction === 'down') {
          _this4._fullTimeout = activeDelayOut + currentDelayIn + _this4._baseDelay;
          activeScreen.classList.add('up');
          currentScreen.classList.add('up');
          activeScreen.classList.add('shown-out');
          setTimeout(function () {
            _this4._nextScreenTimerCircle.classList.add('is-active');

            _this4._nextScreenTimerCircle.style.transition = "stroke-dashoffset ".concat(_this4._fullTimeout, "ms");
          }, 100);
          setTimeout(function () {
            _this4._background.style.backgroundColor = currentScreen.dataset.background;
          }, backgroundDelayIn);

          if (activeScreen.hasAttribute('data-card-hide')) {
            _this4._cardAnimation.classList.add('hide-block');
          }

          setTimeout(function () {
            activeScreen.classList.remove('is-active');
            currentScreen.classList.add('is-active');
            currentScreen.classList.add('shown-in');

            if (currentScreen.hasAttribute('data-card-start')) {
              _this4._cardAnimation.classList.add('start-show');
            }

            if (currentScreen.hasAttribute('data-card-hide')) {
              _this4._cardAnimation.classList.remove('show-vibe');

              _this4._cardAnimation.classList.add('hide-vibe');
            }

            if (_this4._currentScreenIndex === _this4._screens.length - 1) {
              _this4._bottomBlock.classList.add('is-final');
            }
          }, activeDelayOut);
          setTimeout(function () {
            _this4._wrapper.classList.remove('no-action');

            _this4._wrapper.classList.remove('no-move');

            _this4._activeScreenIndex = _this4._currentScreenIndex;
            activeScreen.classList.remove('up');
            currentScreen.classList.remove('up');

            _this4._nextScreenTimerButton.classList.add('is-active');
          }, activeDelayOut + currentDelayIn + _this4._baseDelay);
          return;
        }

        _this4._fullTimeout = currentDelayOut + activeDelayIn + _this4._baseDelay;
        activeScreen.classList.add('down');
        currentScreen.classList.add('down');
        activeScreen.classList.remove('shown-in');
        setTimeout(function () {
          _this4._nextScreenTimerCircle.classList.add('is-active');
        ...
        if (activeScreen.hasAttribute('data-card-hide')) {
          _this4._cardAnimation.classList.remove('hide-vibe');

          _this4._cardAnimation.classList.add('show-vibe');
        }

        if (activeScreen.hasAttribute('data-card-start')) {
          _this4._cardAnimation.classList.remove('start-show');

          _this4._cardAnimation.classList.remove('show-vibe');
        }

        if (_this4._activeScreenIndex === _this4._screens.length - 1) {
          _this4._bottomBlock.classList.remove('is-final');
        }
        ...
        setTimeout(function () {
          activeScreen.classList.remove('is-active');
          currentScreen.classList.add('is-active');
          currentScreen.classList.remove('shown-out');

          if (currentScreen.hasAttribute('data-card-hide')) {
            _this4._cardAnimation.classList.remove('hide-block');
          }
        }, activeDelayIn);
        setTimeout(function () {
          _this4._wrapper.classList.remove('no-action');
          ...
          _this4._activeScreenIndex = _this4._currentScreenIndex;
          activeScreen.classList.remove('down');
          currentScreen.classList.remove('down');
        ...
        }, currentDelayOut + activeDelayIn + _this4._baseDelay);
      }, this._headerTimeout);
    }
  }, {
    key: "_onNextScreenButtonClick",
    value: function _onNextScreenButtonClick(evt) {
      evt.preventDefault();

      if (this._activeScreenIndex < this._screens.length) {
        this._direction = 'down';
        this._currentScreenIndex = this._activeScreenIndex + 1;
    ...
    key: "_onWheelEvent",
    value: function _onWheelEvent(evt) {
      var _this5 = this;

      if (this._wrapper.classList.contains('no-move')) {
        return;
      }

      this._onMouseWheel = evt.deltaY > 60 || evt.deltaY < -60 || evt.wheelDeltaY > 100 || evt.wheelDeltaY < -100;
      ...
      if (evt.deltaY > 0 && (this._wheels.length === this._wheelShift || this._onMouseWheel) && this._activeScreenIndex < this._screens.length - 1) {
        this._currentScreenIndex = this._activeScreenIndex + 1;
        this._direction = 'down';
      ...
      if (evt.deltaY < 0 && (this._wheels.length === this._wheelShift || this._onMouseWheel) && this._activeScreenIndex) {
        this._currentScreenIndex = this._activeScreenIndex - 1;
        this._direction = 'up';
    ...
    key: "_onWindowTouchStar",
    value: function _onWindowTouchStar(evt) {
      if (this._wrapper.classList.contains('no-move')) {
        return;
      }

      this._startPointY = evt.changedTouches[0].clientY;
    }
  }, {
    key: "_onWindowTouchEnd",
    value: function _onWindowTouchEnd(evt) {
      if (this._wrapper.classList.contains('no-move')) {
        return;
      }

      this._stopPointY = evt.changedTouches[0].clientY;

      if (this._startPointY + this._touchShift < this._stopPointY && this._activeScreenIndex) {
        this._currentScreenIndex = this._activeScreenIndex - 1;
        this._direction = 'up';
      ...
      if (this._startPointY - this._touchShift >= this._stopPointY && this._activeScreenIndex < this._screens.length - 1) {
        this._currentScreenIndex = this._activeScreenIndex + 1;
        this._direction = 'down';
      ...
      this._startPointY = this._stopPointY = null;
    }
  }, {
    key: "_activateScreenChange",
    value: function _activateScreenChange() {
      var _this6 = this;

      this._startAnimation();

      this._nextScreenButtons.forEach(function (button) {
        return button.addEventListener('click', _this6._onNextScreenButtonClick);
      });

      document.addEventListener('wheel', this._onWheelEvent);
      window.addEventListener('touchstart', this._onWindowTouchStar);
    ...
    value: function init() {
      ...
      } else if (this._navigation) {
        setTimeout(function () {
          _this7._navigation.classList.add('shown-in');
        }, this._blockDelay);
      }
    }
  }]);
...
var initTabs = function initTabs() {
  tabs = new _tabs__WEBPACK_IMPORTED_MODULE_0__["Tabs"](); // Раскомментировать только при запросе бэкэнда на вынос экземпляра класса в глобальную область видимости
  // window.tabs = tabs;
};
  ...
  _createClass(FocusLock, [{
    ...
    value: function _documentKeydownHandler(evt) {
      ...
      if (evt.key === 'Tab') {
        ...
        if (_typeof(this._lockedSelector) === 'object' && this._lockedSelector.lenth === 2) {
          if (this._focusableElements.length > 1 && !activeElement.closest(this._lockedSelector[0]) && !activeElement.closest(this._lockedSelector[1])) {
            evt.preventDefault();
        ...
        } else if (_typeof(this._lockedSelector) === 'object' && this._lockedSelector.lenth === 3) {
          if (this._focusableElements.length > 1 && !activeElement.closest(this._lockedSelector[0]) && !activeElement.closest(this._lockedSelector[1]) && !activeElement.closest(this._lockedSelector[3])) {
            evt.preventDefault();
    ...
    value: function lock(lockedSelector) {
      ...
      if (_typeof(lockedSelector) === 'object') {
        var elements = [];
        lockedSelector.forEach(function (selector) {
          var _elements;

          lockedElement = document.querySelector(selector);
          elements = (_elements = elements).concat.apply(_elements, _toConsumableArray(lockedElement.querySelectorAll(_this._selectors)));
        });
        this._lockedSelector = lockedSelector;
        this._focusableElements = elements;
      } else {
        this._lockedSelector = lockedSelector;
        lockedElement = document.querySelector(this._lockedSelector);
...
/******/ });
// # sourceMappingURL=main.min.js.maps